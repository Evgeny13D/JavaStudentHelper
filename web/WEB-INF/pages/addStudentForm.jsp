                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="firstName" placeholder="Evgeny" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="secondName" placeholder="Kapliarchyk" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="avgMark" placeholder="9.4" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="groupNumber" placeholder="441501" />
                                    </div>
                                </div>
                            </div>
